...
local newrender = newDrawing

local destroy = function(drawing)
    drawing:Remove()
end

local setproperty = setrenderproperty or function(object, property, value)
    object[property] = value
end

local getproperty = getrenderproperty or function(object, property)
...
local Render = {Fonts = Drawing.Fonts, ZIndex = 6000}
...
function components.button(section, options, zindex)
    ...
    local outlinebutton = section.content:Create("Square", {
    ...
    local button = outlinebutton:Create("Square", {
...
function components.toggle(holder, options, zindex)
    ...
    local iconoutline = holder.main:Create("Square", {
    ...
    local icon = iconoutline:Create("Square", {
        Size = newUDim2(1, -2, 1, -2),
        Position = newUDim2(0, 1, 0, 1),
        ZIndex = zindex + 1,
        Theme = "Object Background",
...
function components.box(section, options, zindex)
    ...
    local boxoutline = section.content:Create("Square", {
        Size = newUDim2(1, 0, 0, 17),
        ZIndex = zindex,
        Theme = "Object Border",
        Outline = false
    ...
    local box = boxoutline:Create("Square", {
        Size = newUDim2(1, -2, 1, -2),
        Position = newUDim2(0, 1, 0, 1),
        ZIndex = zindex + 1,
        Theme = "Object Background",
...
function components.list(options)
    ...
    local topOutline = list:Create("Square", {
...
function library:Window(options)
    ...
    function window_types:Section(options)
        ...
        local sectionoutline = column:Create("Square", {
        ...
        local section = sectionoutline:Create("Square", {
            Size = newUDim2(1, -2, 1, -2),
            Position = newUDim2(0, 1, 0, 1),
            ZIndex = 78,
            Theme = "Section Background",
        ...
        local section_types = {tab = window_types, main = sectionoutline, content = section_content, Resize = function(self)
...
-- local Window = library:Load({ title = "Moonlight", fontsize = 13, theme = "Default", folder = "testui", game =  "lewl", playerlist = true, performancedrag = true, discord = "https://discord.gg/jYrvZb4A35" })
		
-- local Watermark = library:Watermark("Moonlight | Public | Phantom Forces | https://phantom-forces.xyz/")
-- --
