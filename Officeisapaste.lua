...
local ProggyFile = writefile("Proggy.ttf", base64_decode(game:HttpGet("https://raw.githubusercontent.com/OxygenClub/Random-LUAS/main/Proggy.txt")))
...
local MinecraftiaFile = writefile("Minecraftia.ttf", base64_decode(game:HttpGet("https://raw.githubusercontent.com/OxygenClub/Random-LUAS/main/Minecraftia.txt")))
...
local SmallestPixel7File = writefile("SmallestPixel7.ttf", base64_decode(game:HttpGet("https://raw.githubusercontent.com/OxygenClub/Random-LUAS/main/Smallest%20Pixel.txt")))
